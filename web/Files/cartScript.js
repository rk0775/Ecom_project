...
function addToCart(pid,pname,pprice){
    console.log("hello i am in script");
    ...
    if(cart==null){
        ...
        if(oldcart){
            ...
            toast:"true",
            background:"#ffe996",
            html:"<h6 class='text-dark text-small px-1'>product quentity incresed...</h6>",
            position:"bottom",    
            showConfirmButton:false,
            timer:"2000",
            timerProgressBar:true,
           ...
           swal.fire({
            toast:"true",
            background:"#ffe996",
            html:"<h6 class='text-dark text-small px-1'>New product add to cart..</h6>",
            position:"bottom",
...
function removeProduct(pid){
   ...
   updateCart();
    swal.fire({
            toast:"true",
            background:"#fecc0f",
            html:"<h6 class='text-dark text-small px-1'>Product remove from cart!! </h6>",
            position:"bottom",
